        ...
        return{
                ...
                if(mobileDevice||location.href.match('extensions/mobiletab/')){
                    ...
                    $(".cometchat_ccmobiletab_redirect ,.cometchat_ccmobiletab_tabalert").live('click', function(){
                        ...
                        if(typeof(mobiletabwindow)=='undefined'){
                            mobiletabwindow = window.open(jqcc.cometchat.getBaseUrl()+'extensions/mobilewebapp/index.php?cookiePrefix='+cookiePrefix+'&basedata='+jqcc.cometchat.getBaseData()+'&ccmobileauth='+jqcc.cometchat.getThemeVariable('ccmobileauth'), 'mobiletab', '_blank');
                        }else if(mobiletabwindow.top === null || mobiletabwindow.document.URL.indexOf("/mobilewebapp/") < 0){
                            mobiletabwindow = window.open(jqcc.cometchat.getBaseUrl()+'extensions/mobilewebapp/index.php?cookiePrefix='+cookiePrefix+'&basedata='+jqcc.cometchat.getBaseData()+'&ccmobileauth='+jqcc.cometchat.getThemeVariable('ccmobileauth'), 'mobiletab', '_blank');
                        }
                    ...
                    if(amount===0){
                        ...
                        if( typeof(jqcc.cookie("cc_mobilewebapp_open"))=="undefined" || parseInt(jqcc.cookie("cc_mobilewebapp_open")) != 1 ){
                            if(confirm("<?php echo $language[52]; ?>")){
                                ...
                                $(".cometchat_ccmobiletab_redirect .cometchat_ccmobiletab_tabalert").remove();
                                if(typeof(mobiletabwindow)=='undefined'){
                                    mobiletabwindow = window.open(jqcc.cometchat.getBaseUrl()+'extensions/mobilewebapp/index.php?cookiePrefix='+cookiePrefix+'&basedata='+jqcc.cometchat.getBaseData()+'&ccmobileauth='+jqcc.cometchat.getThemeVariable('ccmobileauth')+'#user-'+toid, 'mobiletab', '_blank');
                                }else if(mobiletabwindow.top === null || mobiletabwindow.document.URL.indexOf("/mobilewebapp/") < 0){
                                    mobiletabwindow = window.open(jqcc.cometchat.getBaseUrl()+'extensions/mobilewebapp/index.php?cookiePrefix='+cookiePrefix+'&basedata='+jqcc.cometchat.getBaseData()+'&ccmobileauth='+jqcc.cometchat.getThemeVariable('ccmobileauth')+'#user-'+toid, 'mobiletab', '_blank');
                                }
                                mobiletabwindow.focus();
            ...
            chatWith: function(id) {
                if(mobileDevice && typeof(id)!='undefined'){
                    ...
                    $(".cometchat_ccmobiletab_redirect .cometchat_ccmobiletab_tabalert").remove();
                    if(typeof(mobiletabwindow)=='undefined'){
                        mobiletabwindow = window.open(jqcc.cometchat.getBaseUrl()+'extensions/mobilewebapp/index.php?cookiePrefix='+cookiePrefix+'&basedata='+jqcc.cometchat.getBaseData()+'&ccmobileauth='+jqcc.cometchat.getThemeVariable('ccmobileauth')+'#user-'+id, 'mobiletab', '_blank');
                    }else if(mobiletabwindow.top === null || mobiletabwindow.document.URL.indexOf("/mobilewebapp/") < 0){
                        mobiletabwindow = window.open(jqcc.cometchat.getBaseUrl()+'extensions/mobilewebapp/index.php?cookiePrefix='+cookiePrefix+'&basedata='+jqcc.cometchat.getBaseData()+'&ccmobileauth='+jqcc.cometchat.getThemeVariable('ccmobileauth')+'#user-'+id, 'mobiletab', '_blank');
                    }
                mobiletabwindow.focus();
