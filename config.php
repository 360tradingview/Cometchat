...
$plugins = array('smilies','clearconversation','chattime','audiochat','filetransfer');
...
$crplugins = array('filetransfer','smilies','chathistory','chattime');
...
define('ADMIN_USER','xxxx');

define('ADMIN_PASS','xxxx');
...
$messageBeep = '0';			// Beep on arrival of message from new user?
$beepOnAllMessages = '0';			// Beep on arrival of all messages?
...
$displayOfflineNotification = '0';			// If yes, user offline notification will be displayed
$displayOnlineNotification = '0';			// If yes, user online notification will be displayed
$displayBusyNotification = '0';			// If yes, user busy notification will be displayed
...
$prependLimit = '100';			// Number of messages that are fetched when load earlier messages is clicked
...
define('KEY_A','pub-c-84d424e8-b221-4931-a6a3-f181b7db587e');

define('KEY_B','sub-c-f634c94e-f342-11e4-8061-0619f8945a4f');

define('KEY_C','a1e4c08c706c294a3f1be6145417600f');
